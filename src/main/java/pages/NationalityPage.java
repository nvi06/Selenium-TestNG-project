...
public class NationalityPage extends TestBase{
public static Select sel;
	...
	@FindBy(css="a.natandrace")
	WebElement nationality_element;
	
	@FindBy(xpath="//*[@class=\"natandrace\"]/*[text()=\"Nationality\"]")
	WebElement Nationality_s_element;
	...
	@FindBy(css="input.formInputText")
	WebElement name_txt;
	...
	public void Hover_from_Admin_to_Nationality() 
	{
		ac.moveToElement(nationality_element).build().perform();
	}
	
	public void click_Nationality() 
	{
		Nationality_s_element.click();
	}
